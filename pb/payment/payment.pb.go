...
const file_proto_payment_proto_rawDesc = "" +
	"\n" +
	"\x13proto/payment.proto\x12\apayment\"t\n" +
	"\n" +
	"PayRequest\x12\x19\n" +
...
var file_proto_payment_proto_depIdxs = []int32{
	0, // 0: payment.PaymentService.ProcessPayment:input_type -> payment.PayRequest
	1, // 1: payment.PaymentService.ProcessPayment:output_type -> payment.PayResponse
