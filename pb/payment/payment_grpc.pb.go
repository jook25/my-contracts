...
type PaymentServiceClient interface {
	ProcessPayment(ctx context.Context, in *PayRequest, opts ...grpc.CallOption) (*PayResponse, error)
}
...
func (c *paymentServiceClient) ProcessPayment(ctx context.Context, in *PayRequest, opts ...grpc.CallOption) (*PayResponse, error) {
...
type PaymentServiceServer interface {
	ProcessPayment(context.Context, *PayRequest) (*PayResponse, error)
...
func (UnimplementedPaymentServiceServer) ProcessPayment(context.Context, *PayRequest) (*PayResponse, error) {
...
func _PaymentService_ProcessPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ProcessPayment(ctx, req.(*PayRequest))
	}
